...
// Route::any('/email/resend', [EmailController::class, 'send'])->name('verification.resend');

Route::get('/email/resend', 'Auth\VerificationController@show')->name('verification.resend');
