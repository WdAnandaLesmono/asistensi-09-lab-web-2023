...
class ProductController extends Controller
{
    ...
    public function search(Request $request) 
    {
        ...
        $products = Product::where('productLine', $productLine)->get(); //mencari produk

        return view('productlines', ['products' => $products]); //mengirimkan hasil pencarian, dgn metode view
    }
