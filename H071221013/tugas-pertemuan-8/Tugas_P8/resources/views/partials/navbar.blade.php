<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #FF6C22;">
    <div class="container mb-4 mt-4">
        ...
        <div class="collapse navbar-collapse ms-4" id="navbarNav">
            ...
            <form class="d-flex align-items-end" action="{{ route('products.search') }}" method="GET">
                ...
                <button class="btn btn-secondary" style="background-color: #FFD099; color: #000000" type="submit">Search</button>
            </form>            
        </div>
    </div>
</nav>
