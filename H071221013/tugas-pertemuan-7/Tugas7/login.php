                ...
                <div class="card-body">
                    <?php if ($process == 'successregister'): ?>
                        <div class="alert alert-success"
                            style="background-color: orange; padding: 1em; color: white; border-radius: 20px; text-align: center;">
                    ...
                    <p style="text-align: center;"><span class="custom-text-color">Belum punya akun?</span> <br> 
                            <div class="a-container">
                                <a href="<?= BASE_URL . "registeradm.php" ?>" class=""> Daftar admin</a> <br>
                                <a href="<?= BASE_URL . "registermhs.php" ?>" class=""> Daftar mahasiswa</a>
                            </div>
                        </span></p>
                </div>
            </div>
