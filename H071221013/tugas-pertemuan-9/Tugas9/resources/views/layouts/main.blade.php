...
<body>
    ...
    <nav class="navbar navbar-expand-lg pt-4 pb-4" style="background-color: #4F709C; color:beige;">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                style="color: #000000;" class="bi bi-house-down" viewBox="0 0 16 16">
                                <path
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/product">Menu</a></li>
                        </ul>
                    </li>
                </ul>
                <form class="d-flex" role="search" action="{{ route('jenis') }}" method="GET">
                    <input class="form-control me-3" type="search" name="jenis" placeholder="Search Menu"
                        aria-label="Search">
